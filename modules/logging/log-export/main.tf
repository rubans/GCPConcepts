...
locals {
  resource_abbr = "sink"
  # No random id as it isn't necessary
  # The sink might not sit in a project
  log_sink_name = lower("${var.prefix}-${var.env}-${var.description}-${local.resource_abbr}")
  ...
  log_sink_writer_identity = local.is_project_level ? element(concat(google_logging_project_sink.sink.*.writer_identity, tolist([""])), 0) : local.is_folder_level ? element(concat(google_logging_folder_sink.sink.*.writer_identity, tolist([""])), 0) : local.is_org_level ? element(concat(google_logging_organization_sink.sink.*.writer_identity, tolist([""])), 0) : local.is_billing_level ? element(concat(google_logging_billing_account_sink.sink.*.writer_identity, tolist([""])), 0) : ""
  log_sink_resource_id     = local.is_project_level ? element(concat(google_logging_project_sink.sink.*.id, tolist([""])), 0) : local.is_folder_level ? element(concat(google_logging_folder_sink.sink.*.id, tolist([""])), 0) : local.is_org_level ? element(concat(google_logging_organization_sink.sink.*.id, tolist([""])), 0) : local.is_billing_level ? element(concat(google_logging_billing_account_sink.sink.*.id, tolist([""])), 0) : ""
  log_sink_resource_name   = local.is_project_level ? element(concat(google_logging_project_sink.sink.*.name, tolist([""])), 0) : local.is_folder_level ? element(concat(google_logging_folder_sink.sink.*.name, tolist([""])), 0) : local.is_org_level ? element(concat(google_logging_organization_sink.sink.*.name, tolist([""])), 0) : local.is_billing_level ? element(concat(google_logging_billing_account_sink.sink.*.name, tolist([""])), 0) : ""
  log_sink_parent_id       = local.is_project_level ? element(concat(google_logging_project_sink.sink.*.project, tolist([""])), 0) : local.is_folder_level ? element(concat(google_logging_folder_sink.sink.*.folder, tolist([""])), 0) : local.is_org_level ? element(concat(google_logging_organization_sink.sink.*.org_id, tolist([""])), 0) : local.is_billing_level ? element(concat(google_logging_billing_account_sink.sink.*.billing_account, tolist([""])), 0) : ""
